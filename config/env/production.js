...
module.exports = {
    ...
    models: {
        ...
        schema: true,
        attributes: {
            id: {type: 'number', autoIncrement: true, columnType: 'serial NOT NULL'},
            createdAt: {
                type: 'ref',
                autoCreatedAt: true,
    ...
    security: {
        ...
        cors: {
            allRoutes: true,
            allowOrigins: '*',
            allowRequestHeaders: 'Content-Type, authorization, access-control-allow-origin, utcoffset, timezone, Origin, X-Auth-Token, source, distinctid, currency, orderid, secretkey',
    ...
    custom: {
        ...
        balanceToken: process.env.GET_BALANCE_TOKEN,
        allowPayWithTerms: process.env.GET_BALANCE_ALLOW_PAY_WITH_TERMS,
        balanceUrl: process.env.GET_BALANCE_URL,
